...
import com.ite.sws.databinding.BottomSheetCartShareBinding
 ...
 * </pre>
 */
class CartShareBottomSheet : BottomSheetDialogFragment() {

    // ViewBinding 객체 선언
    private var _binding: BottomSheetCartShareBinding? = null
    ...
    override fun onCreateView(
        ...
        // ViewBinding 객체 초기화
        _binding = BottomSheetCartShareBinding.inflate(inflater, container, false)
        return binding.root
    }
